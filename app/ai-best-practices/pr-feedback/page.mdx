...
1. **Inspect.** Fetch PR details, review comments, and CI checks using
   GitHub CLI.
...
5. **Deliver.** Batch the changes into a commit, push, and provide review
   responses and a handoff summary.
...
flowchart TD
  ...
  fixes --> delivery["Batch commit, push, and summarize"]
  delivery --> human["Developer reviews the changes"]
