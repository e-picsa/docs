...
## Automated PR Feedback & Review Workflows

When managing PRs created by agents or developers, automated tools like **PR-Agent** and **SonarQube** post review comments and improvement suggestions.

To help agents quickly triage feedback, push back on invalid recommendations, and prevent re-work loops, check out our guide:
👉 **[Automated PR Feedback & Review Workflows](/ai-best-practices/pr-feedback)**
